...
@Component({
  selector: 'app-view-courier-recived-list',
  templateUrl: './view-courier-recived-list.component.html',
  styleUrls: ['./view-courier-recived-list.component.css']
})
export class ViewCourierRecivedListComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.gerCourierServise.getCourier('Received').subscribe((res:any)=>{
      this.form = res;    
